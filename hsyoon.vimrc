...
" Define how to display whitespace characters
...
set wildmode=longest,full " longest:full,full   " Command-line completion mode
" ---- Window Management ---- "
...
nnoremap <S-f>                  :exec '/\v(uvm_error\|uvm_fatal\|\*E)\c'<CR>
